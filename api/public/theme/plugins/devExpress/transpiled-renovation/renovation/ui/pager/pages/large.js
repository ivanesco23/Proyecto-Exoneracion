  ...
  _createClass(PagesLarge, [{
    ...
    get: function get() {
      ...
      return this.__getterCache["pages"] = function () {
        ...
        var rtlPageIndexes = (_this3$config = _this3.config) !== null && _this3$config !== void 0 && _this3$config.rtlEnabled ? _toConsumableArray(_this3.pageIndexes).reverse() : _this3.pageIndexes;
