  ...
  _createClass(Tooltip, [{
    ...
    get: function get() {
      var _this$props4 = this.props,
          argumentFormat = _this$props4.argumentFormat,
          arrowLength = _this$props4.arrowLength,
          arrowWidth = _this$props4.arrowWidth,
          border = _this$props4.border,
          className = _this$props4.className,
          color = _this$props4.color,
          container = _this$props4.container,
          contentTemplate = _this$props4.contentTemplate,
          cornerRadius = _this$props4.cornerRadius,
          customizeTooltip = _this$props4.customizeTooltip,
          data = _this$props4.data,
          enabled = _this$props4.enabled,
          eventData = _this$props4.eventData,
          font = _this$props4.font,
          format = _this$props4.format,
          interactive = _this$props4.interactive,
          location = _this$props4.location,
          offset = _this$props4.offset,
          onTooltipHidden = _this$props4.onTooltipHidden,
          onTooltipShown = _this$props4.onTooltipShown,
          opacity = _this$props4.opacity,
          paddingLeftRight = _this$props4.paddingLeftRight,
          paddingTopBottom = _this$props4.paddingTopBottom,
          rootWidget = _this$props4.rootWidget,
