...
import { getAppointmentTakesAllDay } from './appointments/dataProvider/utils'; // STYLE scheduler
  ...
  _appointmentsConfig() {
    var config = {
      ...
      onContentReady: () => {
        ...
        (_this$_workSpace = this._workSpace) === null || _this$_workSpace === void 0 ? void 0 : _this$_workSpace.option('allDayExpanded', this._isAllDayExpanded(this.filteredItems));
      }
    };
    return config;
  }
