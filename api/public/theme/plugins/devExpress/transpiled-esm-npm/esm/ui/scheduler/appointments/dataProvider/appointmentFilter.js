...
import { compareDateWithStartDayHour, compareDateWithEndDayHour, getTrimDates, replaceWrongEndDate, getAppointmentTakesSeveralDays, _appointmentPartInInterval, getRecurrenceException, getAppointmentTakesAllDay } from './utils';
...
export class AppointmentFilterBaseStrategy {
  ...
  filterPreparedItems(filterOptions, preparedItems) {
    ...
    return query(preparedItems || this.preparedItems
    /* Only for QUnit tests */
