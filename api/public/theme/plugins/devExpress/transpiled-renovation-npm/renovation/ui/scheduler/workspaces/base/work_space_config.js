...
var getMonthViewConfig = function getMonthViewConfig(crossScrollingEnabled, _, isVerticalGrouping) {
  return {
    headerPanelTemplate: _layout4.HeaderPanelLayout,
...
var getViewRenderConfigByType = function getViewRenderConfigByType(viewType, crossScrollingEnabled, intervalCount, isVerticalGrouping) {
